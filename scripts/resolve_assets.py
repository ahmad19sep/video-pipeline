#!/usr/bin/env python3
"""Resolve a validated CutMachine plan through the Phase 7 asset boundary."""
...
def main() -> int:
    ...
    configure_logging()
    try:
        result = run_internal_stage(args.root.resolve(), args.project, "assets_ready")
    except RuntimeError as exc:
        print(f"CutMachine asset error: {exc}", file=sys.stderr)
        return 1
