#!/usr/bin/env python3
"""Run CutMachine editorial analysis and timeline generation."""
...
def main() -> int:
    ...
    configure_logging()
    try:
        result = run_internal_stage(args.root.resolve(), args.project, "timeline_ready")
    except RuntimeError as exc:
        print(f"CutMachine timeline error: {exc}", file=sys.stderr)
        return 1
