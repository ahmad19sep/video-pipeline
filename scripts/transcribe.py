#!/usr/bin/env python3
"""Run the CutMachine transcription stage and its prerequisites."""
...
def main() -> int:
    ...
    configure_logging()
    try:
        result = run_internal_stage(args.root.resolve(), args.project, "transcribed")
    except RuntimeError as exc:
        print(f"CutMachine transcription error: {exc}", file=sys.stderr)
        return 1
