#!/usr/bin/env python3
"""Run only the CutMachine ingest stage and its prerequisites."""
...
def main() -> int:
    ...
    configure_logging()
    try:
        result = run_internal_stage(args.root.resolve(), args.project, "ingested")
    except RuntimeError as exc:
        print(f"CutMachine ingest error: {exc}", file=sys.stderr)
        return 1
