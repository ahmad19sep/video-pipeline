#!/usr/bin/env python3
"""Render a validated CutMachine project through the Phase 6 draft boundary."""
...
def main() -> int:
    ...
    configure_logging()
    try:
        result = run_internal_stage(args.root.resolve(), args.project, "draft_rendered")
    except RuntimeError as exc:
        print(f"CutMachine render error: {exc}", file=sys.stderr)
        return 1
